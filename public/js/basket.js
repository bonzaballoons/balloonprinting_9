...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/flatpickr/dist/flatpickr.css":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/flatpickr/dist/flatpickr.css ***!
  \***********************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_flatpickr_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./flatpickr.css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/flatpickr/dist/flatpickr.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_flatpickr_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_flatpickr_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
Vue.use((vue_flatpickr_component__WEBPACK_IMPORTED_MODULE_0___default())); // Disable Weekends

window.excludeDates.push(function (date) {
  return date.getDay() === 0 || date.getDay() === 6;
});
var basketView = new Vue({
  el: '#basketView',
  data: {
  ...
  methods: {
    removeProduct: function removeProduct(arrayName, arrayKey) {
      var _this = this;
      ...
      axios.post('/api/basketRemoveProduct', data).then(function (response) {
        _this.calculatingPrice = false;
        $("#basketNumberItems").text(response.data.numberItems);
        _this[arrayName] = response.data.newArray;
        _this.numberItems = response.data.numberItems;
        _this.hireDeliveryDiscount = response.data.hireDeliveryDiscount;
        _this.totalPostageWeight = response.data.totalPostageWeight;
        _this.totalPostageWeightPrice = response.data.totalPostageWeightPrice;
        _this.basketSubtotal = response.data.basketSubtotal;
        _this.totalPrice = response.data.totalPrice;
        _this.postageWeights = response.data.postageWeights;
        _this.expressFees = response.data.expressFees;
        _this.hasBonzaProducts = response.data.hasBonzaProducts;
        _this.hasBonzaPrintedProducts = response.data.hasBonzaPrintedProducts;
      })["catch"](function () {
        _this.calculatingPrice = false;
    ...
    minusQuantity: function minusQuantity(arrayName, arrayKey, quantity) {
    ...
    addQuantity: function addQuantity(arrayName, arrayKey, quantity) {
      quantity = Number(quantity) + 1;
      this.changeQuantity(arrayName, arrayKey, quantity);
    },
    ...
    changeQuantity: function changeQuantity(arrayName, arrayKey, quantity) {
      var _this2 = this;
      ...
      axios.post('/api/basketChangeProductQuantity', data).then(function (response) {
        _this2[arrayName][arrayKey].calculatingPrice = false;
        _this2.calculatingPrice = false;
        _this2[arrayName][arrayKey] = response.data.product;
        $("#navBasketTotalPrice").text(response.data.numberItems);
        _this2.numberItems = response.data.numberItems;
        _this2.totalPostageWeight = response.data.totalPostageWeight;
        _this2.totalPostageWeightPrice = response.data.totalPostageWeightPrice;
        _this2.postageWeights = response.data.postageWeights;
        _this2.basketSubtotal = response.data.basketSubtotal;
        _this2.totalPrice = response.data.totalPrice;
        _this2.hireDeliveryDiscount = response.data.hireDeliveryDiscount;
        _this2.expressFees = response.data.expressFees;
      })["catch"](function () {
        _this2[arrayName][arrayKey].calculatingPrice = false;
        _this2.calculatingPrice = false;
    ...
    changePostageWeight: function changePostageWeight(postageWeightId) {
      var _this3 = this;

      this.calculatingPrice = true;
      axios.post('/api/basketChangePostageWeightId', {
        'postageWeightId': postageWeightId
      }).then(function (response) {
        _this3.calculatingPrice = false;
        $("#navBasketTotalPrice").text(response.data.numberItems);
        _this3.totalPostageWeightPrice = response.data.totalPostageWeightPrice;
        _this3.basketSubtotal = response.data.basketSubtotal;
        _this3.totalPrice = response.data.totalPrice;
      })["catch"](function () {
    ...
    changeHeliumSupplier: function changeHeliumSupplier(productID) {
      var _this4 = this;

      this.loadingSuppliers = true;
      this.supplierList = []; // Open Modal

      $('#modalSearchDepot').modal('show');
      axios.get('/api/heliumSearchSuppliers/' + this.postcode + '/' + productID).then(function (response) {
        _this4.loadingSuppliers = false;
        _this4.supplierList = response.data.suppliers.map(function (supplier) {
          supplier.price = supplier.groupId === 1 ? _this4.bocCollectPrice : _this4.apCollectPrice;
          return supplier;
        });
      });
    },
  ...
  computed: {
    allPostageWeightItems: function allPostageWeightItems() {
  ...
  filters: {
    imgThumb: function imgThumb(refNum) {
      return 'http://bballoons.s3.amazonaws.com/converted_png/' + refNum + '_100.png';
    },
    gramsToKg: function gramsToKg(grams) {
      var kg = grams / 1000;
      return kg.toFixed(2);
    }
  },
  watch: {
    postageWeightId: function postageWeightId(newVal) {
      this.changePostageWeight(newVal);
    },
    bonzaProductsDeliveryDate: function bonzaProductsDeliveryDate(newVal) {
      var _this5 = this;

      this.calculatePrice = true;
      axios.post('/api/basketAddDeliveryDate', {
        'deliveryDate': newVal
      }).then(function (response) {
        _this5.totalPostageWeight = response.data.totalPostageWeight;
        _this5.totalPostageWeightPrice = response.data.totalPostageWeightPrice;
        _this5.postageWeights = response.data.postageWeights;
        _this5.basketSubtotal = response.data.basketSubtotal;
        _this5.totalPrice = response.data.totalPrice;
        _this5.expressFees = response.data.expressFees;
        _this5.expressFeeTotal = response.data.expressFeeTotal;
        _this5.deliveryDateWithin5WorkingDays = response.data.deliveryDateWithin5WorkingDays;
        _this5.printedLatexFromWizard = response.data.printedLatexFromWizard;
        _this5.calculatePrice = false;
      })["catch"](function () {
        _this5.calculatePrice = false;
