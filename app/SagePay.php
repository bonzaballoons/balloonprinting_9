...
class SagePay {
	...
	protected $description = 'Products from Balloonprinting.co.uk';
	...
	public function __construct() {
		...
		$this->successURL = url('order/success');
		$this->failureURL = url('order/failure');
		$this->website = 'balloonprinting.co.uk';
		$this->encryptPassword = env('SAGE_PASSWORD');
	}
	...
	protected function createVendorTxCode() : string {
